...
object KafkaDStream3 {
  def main(args: Array[String]): Unit = {
    ...
    // 定义kafka相关参数
    val groupId: String = "hoult_group01"
    val topics: Array[String] = Array("hoult_topic01", "hoult_topic02")
...
// kafka-topics.sh --zookeeper linux121:2181,linux122:2181,linux123:2181 --create --topic hoult_topic01 --replication-factor 2 --partitions 3
// kafka-topics.sh --zookeeper linux121:2181,linux122:2181,linux123:2181 --create --topic hoult_topic02 --replication-factor 2 --partitions 2